...
public class HouseDealServiceImpl implements HouseDealService {
	...
	// 시도 구군 동 검색
	@Override
	public Map<String, Object> selectDongApt(String dongcode, int buildyear, int aptprice, int page) throws Exception {
		HashMap<String, Object> result = new HashMap<String, Object>();
		result.put("page", page);
	...
	public Map<String, Object> selectAptname(String guguncode, int buildyear, int aptprice, int page, String aptname)
		...
		List<HouseDealDto> housedealList = mapper.selectAptname(aptname, guguncode, buildyear, aptprice,
				(page - 1) * 10);
		result.put("housedealList", housedealList);
		System.out.println(housedealList);
	...
	@Override
	public List<HouseDealDto> selectDetail(long aptCode) throws Exception {
		System.out.println(mapper.selectDetail(aptCode));
